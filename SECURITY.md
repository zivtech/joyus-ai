...
2. **GitHub Private Security Advisory**: Use [GitHub's private vulnerability reporting](https://github.com/zivtech/joyus-ai/security/advisories/new) to submit a report confidentially
