...
Assign both PRs to grndlvl and create a single issue to cover both that's also assigned to him. Please be careful in how you word things: this is a public repo and we don't want people thinking that you/we built something of poor quality. These are really "pre deployment corrections"

### Prompt 27

Great. Now check open PRs for things we need to address
