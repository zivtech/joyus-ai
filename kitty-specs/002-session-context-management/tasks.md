...
- [x] T027 [P] Tool input validation and error response handling (consistent pattern across all 6 tools)
- [x] T028 Claude Desktop/Code MCP configuration (setup instructions, verification steps)
...
- [x] T031 [P] Event handler (classify detected events → EventType, route to snapshot capture)
- [x] T032 [P] MCP ↔ Service IPC (localhost HTTP or unix socket, health check, capture request)
- [x] T033 Service entry point (`bin/joyus-ai-service`, CLI flags, foreground mode)
...
- [x] T038 [P] Logging utility (stderr logger with warn/debug/error levels, verbose mode)
