...
| WP-17: MCP tools | MCP tool definitions for pipeline operations: `pipeline_create`, `pipeline_list`, `pipeline_trigger`, `pipeline_status`, `pipeline_history`, `pipeline_review_decide`, `pipeline_template_list`, `pipeline_template_instantiate`. | `src/tools/pipeline-tools.ts` |
