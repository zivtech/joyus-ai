...
3. **Load context**: Read FEATURE_SPEC, `spec/constitution.md`, and `.kittify/charter/charter.md` if they exist. If governance context is missing, skip Constitution Check and note what is absent. Load IMPL_PLAN template (already copied).
